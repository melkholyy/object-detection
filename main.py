...
blob =  cv2.dnn.blobFromImage(cv2.resize(image,(300,300)), 0.007,(300,300),1)
...
for i in range (detected_objects.shape[2]):
    ...
    if confidence > min_confidence:
        ...
        prediction_text = f"{classes[class_index]}:{100*confidence:0.2f}%"
